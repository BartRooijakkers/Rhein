...
--
-- Host: 127.0.0.1
-- Gegenereerd op: 04 dec 2020 om 12:15
...
(1, 'Bart', 'Rooijakkers', NULL, 'Bart.ar', '$2y$10$D3MGAq6k1OZsbzbhH7jruuTRzcbhTa0I.skKUS6GxPUT5Y0QuGGOa', 12, 1, '2020-12-04 11:14:13'),
...
(8, 'Ad', 'Istrator', 'min', 'admin', '$2y$10$RSRcPCSoEQIuC2FlA1XIteMud1gsJVENnlF3C5PNnESqRCC7HBWOG', 12, 1, '2020-12-04 11:10:01');
...
(3, 80, '2020-11-18 00:00:00', 55.00, 5.00, 6.00, 8.00, 7.00, 5, 14.00, 8.00, 5.00, 4.00, 55.00, 0);
...
(4, 89, 5, 55, 5, 5, 33, 3, 5, 111),
(5, 83, 4, 5, 1, 1, 5, 44, 1, 6);
...
(1, 99, 1, '2020-11-18 17:39:56', 1, 'Jeff', 'Stationair', 8, 'Hulp giek', 6.00, 3.00, 4.00, 88, 6.00, 4.00, 1, 0, 2, 1, '2020-11-26 00:00:00', 'Kleine defecten', 'Testen!', 'Technische Unie', 'Defect', 'BR', 5.00, 'Defect'),
(2, 88, 2, '2020-11-18 17:41:58', 1, 'Thomas', 'Railstellen', 77, 'Fly-jib', 5.00, 4.00, 3.00, 88, 4.00, 5.00, 1, 1, 1, 0, '2021-11-18 00:00:00', 'Helemaal in orde', 'Test de kabel', 'BMN', 'Kabel is in Prima staat', 'BR', 7.00, 'Test opnieuw'),
(3, 9, 1, '2020-11-18 17:57:07', 5, 'Tom', 'Vrijstaand', 5, 'Hulp giek', 44.00, 5.00, 2.00, 8, 6.00, 8.00, 1, 1, 2, 1, '2020-12-05 00:00:00', 'Testtt', 'Werken!', 'Technische Unie', 'Defect', 'BR', 5.00, 'Defect'),
(4, 3, 2, '2020-12-01 13:56:23', 7, 'Wesley', 'Stationair', 11, 'Opbouw giek', 22.00, 33.00, 44.00, 55, 66.00, 77.00, 1, 0, 2, 1, '2020-12-23 00:00:00', 'test', 'Keuring', 'BMN', 'sadasdas', 'dasdsad', 5.00, 'sadas'),
(5, 42, 2, '2020-12-04 12:12:30', 8, 'Morris', 'In gietframe', 8, 'Knik giek', 4.00, 6.00, 8.00, 10, 12.00, 14.00, 1, 0, 2, 0, '2021-07-04 00:00:00', 'Controle gepland voor volgend jaar ', 'Het controleren van de kraan', 'Technische Unie', 'Kraan is helemaal in orde', 'AI', 8.00, 'NVT');
...
--
ALTER TABLE `voorbladen`
  MODIFY `opdracht_nummer` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
COMMIT;
